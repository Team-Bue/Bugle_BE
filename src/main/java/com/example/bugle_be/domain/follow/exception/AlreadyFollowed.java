...
public class AlreadyFollowed extends BugleException {

    public static final BugleException EXCEPTION = new AlreadyFollowed();

    private AlreadyFollowed() {
        super(FollowErrorCode.ALREADY_FOLLOWED);
    }
}
